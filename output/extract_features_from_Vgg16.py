...
TRAIN = "train"   # Chứa dữ liệu để train
TEST = "test"  # Chứa dữ liệu để evaluation, đánh giá model sau khi train
VAL = "val" # chứa dữ liệu validation, đánh giá model trong quá trình train (sau 1 epoch)
BASE_PATH = "C:/Users/Nguyen Van Duc/Desktop/doantonnghiep/data/animals" # Chứa các folder training,evaluation,validation
...
for split in (TRAIN, TEST, VAL):
	...
	print(f"[DEBUG] Looking in: {p}")
	imagePaths = list(paths.list_images(p))
	print(f"[DEBUG] Found {len(imagePaths)} images in {split}")
